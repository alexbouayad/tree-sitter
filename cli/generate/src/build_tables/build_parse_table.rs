...
impl<'a> ParseTableBuilder<'a> {
    ...
    fn compare_precedence(
        ...
        match (left, right) {
            ...
            (Precedence::Integer(l), Precedence::NoPrecedence()) if *l != 0 => l.cmp(&0),
            (Precedence::NoPrecedence(), Precedence::Integer(r)) if *r != 0 => 0.cmp(r),
